...
class AddRecipeDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        buttons = QDialogButtonBox(
            QDialogButtonBox.StandartButton.Ok | QDialogButtonBox.
            StandartButton.Cancel
        )
...
class MainWindow(QWidget):
    def setup_ui(self):
        ...
        self.recipe_liist.recipe_selected.connect(self.on_recipe_selected)
    ...
    def on_recpe_selected(self, name):
